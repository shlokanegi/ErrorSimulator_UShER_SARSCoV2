...
def main():
  ...
  error_count = int((error_rate * tree_mutation_count) / (100 - error_rate))
  ...
  sample_leaf_ids = list(np.random.choice(leaf_ids, size=error_count, p=leaf_mutation_counts / sum_leaf_mutations))
